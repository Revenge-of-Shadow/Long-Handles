...
public class ModItems 
{
    ...
    public static final RegistryObject<Item> WOOD_FELLING_AXE = ITEMS.register("wood_felling_axe", () -> new FellingAxeItem(ModItemTier.WOOD_FELLING_AXE, 2, -3.5f, new Item.Properties().tab(ItemGroup.TAB_COMBAT)));
    public static final RegistryObject<Item> STONE_FELLING_AXE = ITEMS.register("stone_felling_axe", () -> new FellingAxeItem(ModItemTier.STONE_FELLING_AXE, 2, -3.5f, new Item.Properties().tab(ItemGroup.TAB_COMBAT)));
    public static final RegistryObject<Item> IRON_FELLING_AXE = ITEMS.register("iron_felling_axe", () -> new FellingAxeItem(ModItemTier.IRON_FELLING_AXE, 2, -3.5f, new Item.Properties().tab(ItemGroup.TAB_COMBAT)));
